...
class TestImaSteven(unittest2.TestCase):
	...
	def setUp(self):
		self.reportIMA = ReportIMA()

	def testReadDailyInterestAccrualDetailTxtReport(self):
		inputFile = join(self.reportIMA.getCurrentDirectory(), 'samples', 'daily interest 2020-01.txt')
		positions = list(self.reportIMA.getDailyInterestAccrualDetailPositions(inputFile))
	...
	def testGetTaxlotInterestIncome(self):
		d = self.reportIMA.getTaxlotInterestIncome(
				list(self.reportIMA.getDailyInterestAccrualDetailPositions(
						join(self.reportIMA.getCurrentDirectory(), 'samples', 'daily interest 2020-01.txt')
					))
			)
	...
	def testGetTaxlotInterestIncome2(self):
		d = self.reportIMA.getTaxlotInterestIncome(
				list(self.reportIMA.getDailyInterestAccrualDetailPositions(
						join(self.reportIMA.getCurrentDirectory(), 'samples', 'daily interest 2020-02.txt')
					))
			)
	...
	def testGetTaxlotInterestIncome3(self):
		d = self.reportIMA.getTaxlotInterestIncome(
				list(self.reportIMA.getDailyInterestAccrualDetailPositions(
						join(self.reportIMA.getCurrentDirectory(), 'samples', 'daily interest 2020-03.txt')
					))
			)
	...
	def testGetTaxlotInterestIncome4(self):
		d = self.reportIMA.getTaxlotInterestIncome(
				list(self.reportIMA.getDailyInterestAccrualDetailPositions(
						join(self.reportIMA.getCurrentDirectory(), 'samples', 'daily interest 2020-04.txt')
					))
			)
